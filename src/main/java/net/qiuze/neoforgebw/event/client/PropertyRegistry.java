...
public class PropertyRegistry {
    ...
    event.enqueueWork(() -> ItemProperties.register(ModItems.BLOOD.get(),new ResourceLocation(BarrenWilderness.MODID,"size"),(itemStack, level, livingEntity, int_num)-> itemStack.getCount()));
    }
}
